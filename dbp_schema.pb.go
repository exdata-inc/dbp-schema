...
type RealWorldDataStructureProperty struct {
	...
	DbpaDatetimePrecision               *string `protobuf:"bytes,71,opt,name=dbpaDatetimePrecision,proto3,oneof" json:"dbpaDatetimePrecision,omitempty"`                              // Minimum unit when the data field is of datetime type (UNECE Recommendation 20 code, equivalent to @schema:unitCode)
