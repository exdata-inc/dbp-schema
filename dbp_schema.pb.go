...
type RealWorldDataStructureProperty struct {
	...
	// Unit
	UnitText *wrapperspb.StringValue `protobuf:"bytes,40,opt,name=unitText,proto3,oneof" json:"unitText,omitempty"` // Value representing the unit of the variable (unece.org Rec 20 value)
