...
type RealWorldDataBrewerInput struct {
	...
	Dataset             *RealWorldDataset                  `protobuf:"bytes,8,opt,name=dataset,proto3,oneof" json:"dataset,omitempty"`
}
...
type RealWorldDataBrewingDemand struct {
	...
	TimePeriodStart   *string                         `protobuf:"bytes,8,opt,name=timePeriodStart,proto3,oneof" json:"timePeriodStart,omitempty"` // 読み込むデータがいつからのデータか
	TimePeriodEnd     *string                         `protobuf:"bytes,9,opt,name=timePeriodEnd,proto3,oneof" json:"timePeriodEnd,omitempty"`     // 読み込むデータがいつまでのデータか
}
...
type RealWorldDataBrewingSupply struct {
	...
	BrewingArgument []*RealWorldDataBrewingArgument `protobuf:"bytes,6,rep,name=brewingArgument,proto3" json:"brewingArgument,omitempty"`
	TimePeriodStart *string                         `protobuf:"bytes,7,opt,name=timePeriodStart,proto3,oneof" json:"timePeriodStart,omitempty"` // 読み込むデータがいつからのデータか
	TimePeriodEnd   *string                         `protobuf:"bytes,8,opt,name=timePeriodEnd,proto3,oneof" json:"timePeriodEnd,omitempty"`     // 読み込むデータがいつまでのデータか
}
...
type RealWorldDataReadDemand struct {
	...
	Name            *string           `protobuf:"bytes,2,opt,name=name,proto3,oneof" json:"name,omitempty"`
	Url             *string           `protobuf:"bytes,3,opt,name=url,proto3,oneof" json:"url,omitempty"`
	Dataset         *RealWorldDataset `protobuf:"bytes,4,opt,name=dataset,proto3,oneof" json:"dataset,omitempty"`                 // 読み込む実世界データセット
	TimePeriodStart *string           `protobuf:"bytes,5,opt,name=timePeriodStart,proto3,oneof" json:"timePeriodStart,omitempty"` // 読み込むデータがいつからのデータか
	TimePeriodEnd   *string           `protobuf:"bytes,6,opt,name=timePeriodEnd,proto3,oneof" json:"timePeriodEnd,omitempty"`     // 読み込むデータがいつまでのデータか
	SparqlQuery     *string           `protobuf:"bytes,7,opt,name=sparqlQuery,proto3,oneof" json:"sparqlQuery,omitempty"`         // 構造クエリ（SPARQL）
	GraphqlQuery    *string           `protobuf:"bytes,8,opt,name=graphqlQuery,proto3,oneof" json:"graphqlQuery,omitempty"`       // 構造クエリ（GraphQL）
}
...
type RealWorldDataReadSupply struct {
	...
	SparqlQuery     *string           `protobuf:"bytes,7,opt,name=sparqlQuery,proto3,oneof" json:"sparqlQuery,omitempty"`         // 構造クエリ（SPARQL）
	GraphqlQuery    *string           `protobuf:"bytes,8,opt,name=graphqlQuery,proto3,oneof" json:"graphqlQuery,omitempty"`       // 構造クエリ（GraphQL）
	Data            []byte            `protobuf:"bytes,9,opt,name=data,proto3,oneof" json:"data,omitempty"`                       // 実際には MBUS で送る？
}
...
type RealWorldDataWriteDemand struct {
	...
	Name            *string           `protobuf:"bytes,2,opt,name=name,proto3,oneof" json:"name,omitempty"`
	Url             *string           `protobuf:"bytes,3,opt,name=url,proto3,oneof" json:"url,omitempty"`
	Dataset         *RealWorldDataset `protobuf:"bytes,4,opt,name=dataset,proto3,oneof" json:"dataset,omitempty"`                 // 書き込む実世界データセット
	...
	Data            []byte            `protobuf:"bytes,7,opt,name=data,proto3,oneof" json:"data,omitempty"`                       // 実際には MBUS で送る？
}
...
type RealWorldDataMoveDemand struct {
	...
	Name            *string                   `protobuf:"bytes,2,opt,name=name,proto3,oneof" json:"name,omitempty"`
	Url             *string                   `protobuf:"bytes,3,opt,name=url,proto3,oneof" json:"url,omitempty"`
	Dataset         *RealWorldDataset         `protobuf:"bytes,4,opt,name=dataset,proto3,oneof" json:"dataset,omitempty"`                 // 移動する RealWorldDataset
	TimePeriodStart *string                   `protobuf:"bytes,5,opt,name=timePeriodStart,proto3,oneof" json:"timePeriodStart,omitempty"` // 移動する RealWorldDataset のうち対象となるデータの開始時刻はどれだけ前か (ex. 8d → 8日前)
	TimePeriodEnd   *string                   `protobuf:"bytes,6,opt,name=timePeriodEnd,proto3,oneof" json:"timePeriodEnd,omitempty"`     // 移動する RealWorldDataset のうち対象となるデータの終了時刻はどれだけ前か (ex. 7d → 7日前)
...
type RealWorldDataMoveSupply struct {
	...
	Name            *string                   `protobuf:"bytes,2,opt,name=name,proto3,oneof" json:"name,omitempty"`
	Url             *string                   `protobuf:"bytes,3,opt,name=url,proto3,oneof" json:"url,omitempty"`
	Dataset         *RealWorldDataset         `protobuf:"bytes,4,opt,name=dataset,proto3,oneof" json:"dataset,omitempty"`                 // 移動した RealWorldDataset
	TimePeriodStart *string                   `protobuf:"bytes,5,opt,name=timePeriodStart,proto3,oneof" json:"timePeriodStart,omitempty"` // 移動した RealWorldDataset のうち対象となるデータの開始時刻はどれだけ前か (ex. 8d → 8日前)
	TimePeriodEnd   *string                   `protobuf:"bytes,6,opt,name=timePeriodEnd,proto3,oneof" json:"timePeriodEnd,omitempty"`     // 移動した RealWorldDataset のうち対象となるデータの終了時刻はどれだけ前か (ex. 7d → 7日前)
	MoveFrom        *RealWorldDataStoringInfo `protobuf:"bytes,7,opt,name=moveFrom,proto3,oneof" json:"moveFrom,omitempty"`               // データの移動元
	MoveTo          *RealWorldDataStoringInfo `protobuf:"bytes,8,opt,name=moveTo,proto3,oneof" json:"moveTo,omitempty"`                   // データの移動先
...
type RealWorldDataRemoveDemand struct {
	...
	Name            *string                   `protobuf:"bytes,2,opt,name=name,proto3,oneof" json:"name,omitempty"`
	Url             *string                   `protobuf:"bytes,3,opt,name=url,proto3,oneof" json:"url,omitempty"`
	DatasetStore    *RealWorldDataStoringInfo `protobuf:"bytes,4,opt,name=datasetStore,proto3,oneof" json:"datasetStore,omitempty"`       // 削除する RealWorldDataset の RealWorldDataStoringInfo
	TimePeriodStart *string                   `protobuf:"bytes,5,opt,name=timePeriodStart,proto3,oneof" json:"timePeriodStart,omitempty"` // 削除する RealWorldDataset のうち対象となるデータの開始時刻はどれだけ前か (ex. 8d → 8日前)
	TimePeriodEnd   *string                   `protobuf:"bytes,6,opt,name=timePeriodEnd,proto3,oneof" json:"timePeriodEnd,omitempty"`     // 削除する RealWorldDataset のうち対象となるデータの終了時刻はどれだけ前か (ex. 7d → 7日前)
}
...
type RealWorldDataRemoveSupply struct {
	...
	Name            *string                   `protobuf:"bytes,2,opt,name=name,proto3,oneof" json:"name,omitempty"`
	Url             *string                   `protobuf:"bytes,3,opt,name=url,proto3,oneof" json:"url,omitempty"`
	DatasetStore    *RealWorldDataStoringInfo `protobuf:"bytes,4,opt,name=datasetStore,proto3,oneof" json:"datasetStore,omitempty"`       // 削除した RealWorldDataset の RealWorldDataStoringInfo
	TimePeriodStart *string                   `protobuf:"bytes,5,opt,name=timePeriodStart,proto3,oneof" json:"timePeriodStart,omitempty"` // 削除した RealWorldDataset のうち対象となるデータの開始時刻はどれだけ前か (ex. 8d → 8日前)
	TimePeriodEnd   *string                   `protobuf:"bytes,6,opt,name=timePeriodEnd,proto3,oneof" json:"timePeriodEnd,omitempty"`     // 削除した RealWorldDataset のうち対象となるデータの終了時刻はどれだけ前か (ex. 7d → 7日前)
}
...
var file_dbp_schema_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x22, 0xb3, 0x03, 0x0a, 0x18, 0x52, 0x65, 0x61, 0x6c, 0x57, 0x6f, 0x72, 0x6c, 0x64,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x88, 0x01, 0x01, 0x12, 0x41, 0x0a,
	0x19, 0x64, 0x69, 0x73, 0x61, 0x6d, 0x62, 0x69, 0x67, 0x75, 0x61, 0x74, 0x69, 0x6e, 0x67, 0x44,
	0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09,
	0x48, 0x03, 0x52, 0x19, 0x64, 0x69, 0x73, 0x61, 0x6d, 0x62, 0x69, 0x67, 0x75, 0x61, 0x74, 0x69,
	...
	,
	...
	0x72, 0x6c, 0x88, 0x01, 0x01, 0x12, 0x2b, 0x0a, 0x0e, 0x65, 0x6e, 0x63, 0x6f, 0x64, 0x69, 0x6e,
	0x67, 0x46, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x48, 0x03, 0x52,
	0x0e, 0x65, 0x6e, 0x63, 0x6f, 0x64, 0x69, 0x6e, 0x67, 0x46, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x88,
	0x01, 0x01, 0x12, 0x3a, 0x0a, 0x09, 0x73, 0x74, 0x72, 0x75, 0x63, 0x74, 0x75, 0x72, 0x65, 0x18,
	...
	,
	...
	0x75, 0x72, 0x6c, 0x88, 0x01, 0x01, 0x12, 0x3d, 0x0a, 0x09, 0x73, 0x74, 0x61, 0x72, 0x74, 0x54,
	...
	,
	...
	0x64, 0x61, 0x74, 0x61, 0x73, 0x65, 0x74, 0x88, 0x01, 0x01, 0x42, 0x05, 0x0a, 0x03, 0x5f, 0x69,
	0x64, 0x42, 0x07, 0x0a, 0x05, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x42, 0x06, 0x0a, 0x04, 0x5f, 0x75,
	0x72, 0x6c, 0x42, 0x0a, 0x0a, 0x08, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x73, 0x65, 0x74, 0x22, 0xeb,
	0x01, 0x0a, 0x1b, 0x52, 0x65, 0x61, 0x6c, 0x57, 0x6f, 0x72, 0x6c, 0x64, 0x44, 0x61, 0x74, 0x61,
	0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x53, 0x75, 0x70, 0x70, 0x6c, 0x79, 0x12, 0x13,
	...
	,
	...
	0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x6e, 0x66, 0x6f, 0x48, 0x03, 0x52, 0x0e,
	0x63, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x6e, 0x66, 0x6f, 0x88, 0x01,
	0x01, 0x12, 0x37, 0x0a, 0x14, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x66, 0x65,
	0x72, 0x65, 0x6e, 0x63, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x48,
	0x04, 0x52, 0x14, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x66, 0x65, 0x72, 0x65,
	0x6e, 0x63, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x88, 0x01, 0x01, 0x12, 0x45, 0x0a, 0x11, 0x61, 0x63,
	0x74, 0x69, 0x76, 0x65, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x88, 0x01, 0x01, 0x12, 0x2d, 0x0a, 0x0f, 0x74, 0x69, 0x6d, 0x65, 0x50, 0x65, 0x72, 0x69, 0x6f,
	0x64, 0x53, 0x74, 0x61, 0x72, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x48, 0x04, 0x52, 0x0f,
	0x74, 0x69, 0x6d, 0x65, 0x50, 0x65, 0x72, 0x69, 0x6f, 0x64, 0x53, 0x74, 0x61, 0x72, 0x74, 0x88,
	0x01, 0x01, 0x12, 0x29, 0x0a, 0x0d, 0x74, 0x69, 0x6d, 0x65, 0x50, 0x65, 0x72, 0x69, 0x6f, 0x64,
	0x45, 0x6e, 0x64, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x48, 0x05, 0x52, 0x0d, 0x74, 0x69, 0x6d,
	0x65, 0x50, 0x65, 0x72, 0x69, 0x6f, 0x64, 0x45, 0x6e, 0x64, 0x88, 0x01, 0x01, 0x12, 0x25, 0x0a,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
...
var file_dbp_schema_proto_depIdxs = []int32{
	...
	2,  // 10: dbp_schema.RealWorldDataBrewerInput.dataset:type_name -> dbp_schema.RealWorldDataset
	1,  // 11: dbp_schema.RealWorldDataBrewerOutput.outputCharacteristic:type_name -> dbp_schema.VariableCharacteristicEnumeration
	3,  // 12: dbp_schema.RealWorldDataBrewerInfo.inputSpecs:type_name -> dbp_schema.RealWorldDataBrewerInput
	4,  // 13: dbp_schema.RealWorldDataBrewerInfo.outputSpecs:type_name -> dbp_schema.RealWorldDataBrewerOutput
	...
	2,  // 20: dbp_schema.RealWorldDataRegisterDemand.dataset:type_name -> dbp_schema.RealWorldDataset
	2,  // 21: dbp_schema.RealWorldDataRegisterSupply.dataset:type_name -> dbp_schema.RealWorldDataset
	7,  // 22: dbp_schema.RealWorldDataCollectionDemand.collectionInfo:type_name -> dbp_schema.RealWorldDataCollectionInfo
	7,  // 23: dbp_schema.RealWorldDataCollectionSupply.collectionInfo:type_name -> dbp_schema.RealWorldDataCollectionInfo
	7,  // 24: dbp_schema.RealWorldDataCollectionStatus.collectionInfo:type_name -> dbp_schema.RealWorldDataCollectionInfo
	32, // 25: dbp_schema.RealWorldDataCollectionStatus.activeConnections:type_name -> google.protobuf.Struct
	32, // 26: dbp_schema.RealWorldDataCollectionStatus.trafficStatistics:type_name -> google.protobuf.Struct
	6,  // 27: dbp_schema.RealWorldDataBrewingDemand.brewerInfo:type_name -> dbp_schema.RealWorldDataBrewerInfo
	3,  // 28: dbp_schema.RealWorldDataBrewingDemand.brewerInput:type_name -> dbp_schema.RealWorldDataBrewerInput
	5,  // 29: dbp_schema.RealWorldDataBrewingDemand.brewingArgument:type_name -> dbp_schema.RealWorldDataBrewingArgument
	12, // 30: dbp_schema.RealWorldDataBrewingDemand.brewerOutputStore:type_name -> dbp_schema.RealWorldDataStoringInfo
	6,  // 31: dbp_schema.RealWorldDataBrewingSupply.brewerInfo:type_name -> dbp_schema.RealWorldDataBrewerInfo
	4,  // 32: dbp_schema.RealWorldDataBrewingSupply.brewerOutput:type_name -> dbp_schema.RealWorldDataBrewerOutput
	5,  // 33: dbp_schema.RealWorldDataBrewingSupply.brewingArgument:type_name -> dbp_schema.RealWorldDataBrewingArgument
	18, // 34: dbp_schema.RealWorldDataPeriodicBrewingConfig.brewingConfig:type_name -> dbp_schema.RealWorldDataBrewingDemand
	2,  // 35: dbp_schema.RealWorldDataReadDemand.dataset:type_name -> dbp_schema.RealWorldDataset
	2,  // 36: dbp_schema.RealWorldDataReadSupply.dataset:type_name -> dbp_schema.RealWorldDataset
	2,  // 37: dbp_schema.RealWorldDataWriteDemand.dataset:type_name -> dbp_schema.RealWorldDataset
	2,  // 38: dbp_schema.RealWorldDataWriteSupply.dataset:type_name -> dbp_schema.RealWorldDataset
	2,  // 39: dbp_schema.RealWorldDataMoveDemand.dataset:type_name -> dbp_schema.RealWorldDataset
	12, // 40: dbp_schema.RealWorldDataMoveDemand.moveFrom:type_name -> dbp_schema.RealWorldDataStoringInfo
	12, // 41: dbp_schema.RealWorldDataMoveDemand.moveTo:type_name -> dbp_schema.RealWorldDataStoringInfo
	2,  // 42: dbp_schema.RealWorldDataMoveSupply.dataset:type_name -> dbp_schema.RealWorldDataset
	12, // 43: dbp_schema.RealWorldDataMoveSupply.moveFrom:type_name -> dbp_schema.RealWorldDataStoringInfo
	12, // 44: dbp_schema.RealWorldDataMoveSupply.moveTo:type_name -> dbp_schema.RealWorldDataStoringInfo
	2,  // 45: dbp_schema.RealWorldDataMoveSupply.movedDataset:type_name -> dbp_schema.RealWorldDataset
	25, // 46: dbp_schema.RealWorldDataPeriodicMoveConfig.moveConfig:type_name -> dbp_schema.RealWorldDataMoveDemand
	12, // 47: dbp_schema.RealWorldDataRemoveDemand.datasetStore:type_name -> dbp_schema.RealWorldDataStoringInfo
	12, // 48: dbp_schema.RealWorldDataRemoveSupply.datasetStore:type_name -> dbp_schema.RealWorldDataStoringInfo
	28, // 49: dbp_schema.RealWorldDataPeriodicRemoveConfig.removeConfig:type_name -> dbp_schema.RealWorldDataRemoveDemand
